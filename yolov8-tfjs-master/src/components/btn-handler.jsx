  ...
  return (
    <div className="btn-container">
      ...
      <input
        ...
        style={{ display: "none" }}
        onChange={(e) => {// e stand for event.  For every change in the input, this function will be execute
          ...
          console.log("btn-handle:",imageRef.current.value)
        }}
        ref={inputImageRef}
      />
      <button
        onClick={() => {
          ...
          // inputImageRef.current.click() => if click will trigger upload image
      ...
      >
        ...
        {/* if the image is displaying the button will show "close image" and vice versa */}
      </button>
